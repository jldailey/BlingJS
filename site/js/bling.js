...
l>u;l+=5){m=e[l];q=e[l+1];h=e[l+2];r=e[l+3];o=e[l+4];t=c[m];if(t==null)t="missing value: "+m;switch(r){case "d":p[n++]=""+parseInt(t,10);break;case "f":p[n++]=parseFloat(t).toFixed(h);break;case "s":p[n++]=""+t;break;default:p[n++]=""+t}if(q>0)p[n]=String.PadLeft(p[n],q);p[n++]=o}return p.join("")};g=function(f){var c,e,h,l,n,m,p,q,o,r,t,u,B,D;r=null;u=q=l=c=D=B="";e={};o=1;t=d([]);p=0;t.selector=f;m=function(){var w;w=d.HTML.parse(B);r?r.appendChild(w):t.push(w);B="";return o=1};for(n=function(){var w,
x;x=document.createElement(u);x.id=q||null;x.className=l||null;for(w in e)x.setAttribute(w,e[w]);r?r.appendChild(x):t.push(x);r=x;u=q=l=c=D=B="";e={};return o=1};h=f[p++];)if(h==="+"&&o===1){if(r)r=r.parentNode}else if(h==="#"&&(o===1||o===3||o===4))o=2;else if(h==="."&&(o===1||o===2||o===4)){if(l.length>0)l+=" ";o=3}else if(h==="."&&l.length>0)l+=" ";else if(h==="["&&(o===1||o===2||o===3||o===4))o=4;else if(h==="="&&o===4)o=5;else if(h==='"'&&o===1)o=6;else if(h==="'"&&o===1)o=7;else if(h==="]"&&
