...
<<<<<<< HEAD
  var $, Bling, extend,
=======
  var Bling, defineProperty, extend, inherit, isType, _pipe, _ref, _ref1, _type,
  ...
  Bling = (function() {
    ...
    Bling.provides = function(needs, f) {
      return function() {
        ...
        return Bling.provide(needs, f.apply(null, args));
      };
    };
    ...
    $.plugin({
      ...
      return {
        $: {
          ...
          isSimple: function(o) {
            var _ref2;
            return (_ref2 = _type(o)) === "string" || _ref2 === "number" || _ref2 === "bool";
          },
          isEmpty: function(o) {
      ...
      return {
        ...
        skip: function(n) {
          ...
          return $((function() {
            ...
            _results = [];
            for (i = _i = start, _ref2 = this.length; start <= _ref2 ? _i < _ref2 : _i > _ref2; i = start <= _ref2 ? ++_i : --_i) {
              _results.push(this[i]);
            }
            return _results;
          }).call(this));
        ...
        weave: function(b) {
          var c, i, _i, _j, _ref2, _ref3;
          c = $();
          for (i = _i = _ref2 = this.length - 1; _i >= 0; i = _i += -1) {
            c[(i * 2) + 1] = this[i];
          }
          for (i = _j = 0, _ref3 = b.length; _j < _ref3; i = _j += 1) {
            c[i * 2] = b[i];
          }
          return c;
        },
        fold: function(f) {
          ...
          b = $((function() {
            var _i, _ref2, _results;
            _results = [];
            for (i = _i = 0, _ref2 = n - 1; _i < _ref2; i = _i += 2) {
              _results.push(f.call(this, this[i], this[i + 1]));
            }
            return _results;
          }).call(this));
        ...
        $: {
          range: function(start, end, step) {
            ...
            return $((function() {
              var _i, _ref2, _results;
              _results = [];
              for (i = _i = 0, _ref2 = Math.ceil((end - start) / step); 0 <= _ref2 ? _i < _ref2 : _i > _ref2; i = 0 <= _ref2 ? ++_i : --_i) {
...
<<<<<<< HEAD
        ...
        css: function(k, v) {
          var cv, i, n, nn, ov, setter, _i, _ref;
          if ((v != null) || $.is("object", k)) {
            ...
            if ($.is("object", k)) {
              ...
              for (i = _i = 0, _ref = n = Math.max(v.length, nn = setter.len()); _i < _ref; i = _i += 1) {
                setter[i % nn](k, v[i % n], "");
              }
            }
            return this;
          ...
          switch ($.type(d)) {
            ...
            case "array":
              return $((function() {
                var _i, _ref2, _results;
                _results = [];
                for (i = _i = 0, _ref2 = Math.min(this.length, d.length); 0 <= _ref2 ? _i < _ref2 : _i > _ref2; i = 0 <= _ref2 ? ++_i : --_i) {
      ...
      return {
        $: {
          ...
          dashize: function(name) {
            var c, i, ret, _i, _ref2;
            ret = "";
            for (i = _i = 0, _ref2 = (name != null ? name.length : void 0) | 0; 0 <= _ref2 ? _i < _ref2 : _i > _ref2; i = 0 <= _ref2 ? ++_i : --_i) {
              c = name.charCodeAt(i);
              if ((91 > c && c > 64)) {
                c += 32;
                ret += '-';
...
=======
  ...
  (function($) {
    return $.plugin({
      ...
      get = function(name, def) {
        var _ref2;
        return (_ref2 = process.env[name]) != null ? _ref2 : def;
      };
      return {
        $: {
          config: $.extend(get, {
  ...
  (function($) {
    return $.plugin({
      ...
      var adder, d, floor, format_keys, formats, h, m, ms, parser_keys, parsers, s, units, _ref2;
      _ref2 = [1, 1000, 1000 * 60, 1000 * 60 * 60, 1000 * 60 * 60 * 24], ms = _ref2[0], s = _ref2[1], m = _ref2[2], h = _ref2[3], d = _ref2[4];
      units = {
        ms: ms,
        s: s,
        m: m,
        ...
        $: {
          date: {
            ...
            parse: function(dateString, fmt, to) {
              ...
              date = new Date(0);
              for (i = _i = 0, _ref3 = fmt.length; _i < _ref3; i = _i += 1) {
                for (_j = 0, _len = parser_keys.length; _j < _len; _j++) {
                  k = parser_keys[_j];
                  if (fmt.indexOf(k, i) === i) {
                    try {
            ...
            timeoutQueue = $.extend([], (function() {
              ...
              return {
                add: function(f, n) {
                  var i, _i, _ref2;
                  f.order = n + $.now;
                  for (i = _i = 0, _ref2 = this.length; _i <= _ref2; i = _i += 1) {
                    if (i === this.length || this[i].order > f.order) {
                      this.splice(i, 0, f);
                      break;
                    }
    ...
    if ($.global.document != null) {
      return $.plugin({
        ...
        return {
          ...
          replace: function(n) {
            var clones, i, _i, _ref2, _ref3;
            n = toNode(n);
            clones = this.map(function() {
              return n.cloneNode(true);
            });
            for (i = _i = 0, _ref2 = clones.length; _i < _ref2; i = _i += 1) {
              if ((_ref3 = this[i].parentNode) != null) {
                _ref3.replaceChild(clones[i], this[i]);
              }
            }
            return clones;
          },
          ...
          css: function(k, v) {
            var cv, i, n, nn, ov, setter, _i, _ref2;
            if ((v != null) || $.is("object", k)) {
              setter = this.select('style.setProperty');
              if ($.is("object", k)) {
                for (i in k) {
                ...
                for (i = _i = 0, _ref2 = n = Math.max(v.length, nn = setter.len()); _i < _ref2; i = _i += 1) {
                  setter[i % nn](k, v[i % n], "");
                }
              }
              return this;
    ...
    random = (function() {
      ...
      return $.extend(next, {
        real: function(min, max) {
          var _ref2, _ref3;
          if (!(min != null)) {
            _ref2 = [0, 1.0], min = _ref2[0], max = _ref2[1];
          }
          if (!(max != null)) {
            _ref3 = [0, min], min = _ref3[0], max = _ref3[1];
          }
      ...
      return {
        $: {
          sendMail: function(mail, callback) {
            ...
            if ((_ref2 = mail.transport) == null) {
              mail.transport = transport;
            }
            if ((_ref3 = mail.from) == null) {
              mail.from = $.config.get('EMAILS_FROM');
            }
            if ((_ref4 = mail.bcc) == null) {
        ...
        $: {
          StateMachine: StateMachine = (function() {
            ...
            StateMachine.prototype.run = function(inputs) {
              var c, ret, _i, _len, _ref2;
              this.mode = 0;
              for (_i = 0, _len = inputs.length; _i < _len; _i++) {
                c = inputs[_i];
                ret = this.tick(c);
              }
              if ($.is("function", (_ref2 = this.modeline) != null ? _ref2.eof : void 0)) {
...
=======
            ...
            enter: function() {
              var _ref2;
              this.emitNode();
              this.cursor = (_ref2 = this.cursor) != null ? _ref2.parentNode : void 0;
              return this.GO(0);
            }
          }, {
            enter: function() {
...
>>>>>>> f68c123280c09a8f240afe637a2e5d4a64974601
      ...
      compile.cache = {};
      render = function(text, values) {
        var cache, fixed, i, j, key, n, output, pad, rest, type, value, _i, _ref2, _ref3;
        cache = compile.cache[text];
        if (!(cache != null)) {
          cache = compile.cache[text] = compile(text);
        }
        ...
        j = 1;
        n = cache.length;
        for (i = _i = 1, _ref2 = n - 5; _i <= _ref2; i = _i += 5) {
          _ref3 = cache.slice(i, (i + 4) + 1 || 9e9), key = _ref3[0], pad = _ref3[1], fixed = _ref3[2], type = _ref3[3], rest = _ref3[4];
          value = values[key];
          if (!(value != null)) {
            value = "missing value: " + key;
          }
  ...
  (function($) {
    return $.plugin(function() {
      ...
      parseArray = function(x) {
        ...
        data = [];
        while (x.length > 0) {
          _ref2 = parseOne(x), one = _ref2[0], x = _ref2[1];
          data.push(one);
        }
        return data;
      };
      parseObject = function(x) {
        ...
        data = {};
        while (x.length > 0) {
          _ref2 = parseOne(x), key = _ref2[0], x = _ref2[1];
          _ref3 = parseOne(x), value = _ref3[0], x = _ref3[1];
          data[key] = value;
        }
        return data;
      };
        ...
        $: {
          TNET: {
            stringify: function(x) {
              ...
              })(), data = _ref2[0], type = _ref2[1];
              return (data.length | 0) + ":" + data + type;
            },
            parse: function(x) {
              var _ref2;
              return (_ref2 = parseOne(x)) != null ? _ref2[0] : void 0;
            }
          }
        }
      };
    ...
    return $.plugin({
      ...
      $.type.extend({
        ...
        array: {
          trace: function(label, o, tracer) {
            var i, _i, _ref2;
            for (i = _i = 0, _ref2 = o.length; _i < _ref2; i = _i += 1) {
              o[i] = $.trace(o[i], "" + label + "[" + i + "]", tracer);
            }
            return o;
          }
      ...
      return {
        $: {
          trace: function(label, o, tracer) {
            var _ref2;
            if (!$.is("string", label)) {
              _ref2 = [o, label], tracer = _ref2[0], o = _ref2[1];
            }
            tracer || (tracer = $.log);
            label || (label = "");
            return $.type.lookup(o).trace(label, o, tracer);
      ...
      return {
        $: {
          ...
          assertArrayEqual: function(a, b, label) {
            ...
            _results = [];
            for (i = _i = 0, _ref2 = a.length; _i < _ref2; i = _i += 1) {
              try {
        ...
        assertEqual: function() {
          ...
          if (args.length > 1) {
            ...
            a = args[0];
            for (i = _i = 1, _ref2 = args.length; 1 <= _ref2 ? _i < _ref2 : _i > _ref2; i = 1 <= _ref2 ? ++_i : --_i) {
