...
(function() {
  var Bling, defineProperty, extend, inherit, isType, log, _pipe, _ref, _type,
    __slice = [].slice,
    ...
    Bling.depends = function(needs, f) {
      if ((needs = dep.filter(needs)).length === 0) {
        ...
        dep.q.push(function(need) {
          var i;
          if ((i = needs.indexOf(need)) > -1 && needs.length === 0 && f) {
            return needs.splice(i, 1);
          }
        });
      }
      return f;
